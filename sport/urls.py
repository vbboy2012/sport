...
urlpatterns = [
    ...
    url(r'^address/', bse_views.address, name='address'),
    ...
    url(r'^invitation/', bse_views.invitation, name='invitation'),
    url(r'^telegram/', bse_views.telegram, name='telegram'),
    url(r'^addName/', bse_views.addName, name='addName'),
    url(r'^send/', bse_views.send, name='send'),
   # url(r'^eth/', bse_views.eth, name='eth'),
   # url(r'^sendTokenasaddress/(\w+)/(\d+)/$', bse_views.sendTokenasaddress, name='sendTokenasaddress'),
